...
const account1 = {
  ...
  movementsDates: [
    ...
    '2023-03-21T14:11:59.604Z',
    '2023-02-22T17:01:17.194Z',
    '2023-02-25T23:36:17.929Z',
...
console.log(Math.max(20, 30, 10, 15, 25));
console.log(Math.min(20, 30, 10, 15, 25));
...
labelBalance.addEventListener('click', function () {
  [...document.querySelectorAll('.movements__row')].forEach((row, i) => {
    if (i % 2 === 0) row.style.backgroundColor = '#e52a5a';
    if (i % 3 === 0) row.style.backgroundColor = 'goldenRod';
  });
});
///////////////////////////////////////
*/
...
const days1 = calcDaysPassed(new Date(2037, 3, 15), new Date(2037, 3, 25));
console.log(days1);
///////////////////////////////////////
*/
...
console.log('Styria: ', new Intl.NumberFormat('ar-SY', options).format(num));
console.log(
  navigator.language,
...
//     second: 'numeric',
//   };
//   console.log(Intl.DateTimeFormat(option).format(now));
// }, 3000);
///////////////////////////////////////
*/
